...
let () =
  ...
  let solve_puzzle =
    ...
    | 2024, 6 -> Year2024.Day06.run ?input
    | 2024, 7 -> Year2024.Day07.run ?input
    | 2024, 9 -> Year2024.Day09.run ?input
    | 2024, 11 -> Year2024.Day11.run ?input
    | 2024, 19 -> Year2024.Day19.run ?input
    | 2024, 22 -> Year2024.Day22.run ?input
